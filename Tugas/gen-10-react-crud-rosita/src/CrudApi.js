...
export default function CrudApi() {
  ...
  function handleSubmit(event) {
    ...
    if (formInput.id) {
      // kalau ada id nya pasti mengupdate
      updateProduct();
    } else {
      createProduct();
    }
      ...
      <form onSubmit={(event) => handleSubmit(event)}>
        ...
        <label>
          ...
          <input
            ...
            onChange={(event) => handleInput(event, "color")}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            onChange={(event) => handleInput(event, "size")}
          />
        </label>
      ...
      <ul>
        {products.map((product) => (
          <li key={product.id}>
            ...
            &nbsp;&nbsp;
            <button onClick={() => prepareUpdate(product)}>Update</button>
            &nbsp;&nbsp;
